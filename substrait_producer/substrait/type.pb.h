...
// repeated uint32 sizes = 3;
inline int NamedStruct::_internal_sizes_size() const {
  return _impl_.sizes_.size();
}
inline int NamedStruct::sizes_size() const {
  return _internal_sizes_size();
}
inline void NamedStruct::clear_sizes() {
  _impl_.sizes_.Clear();
}
inline uint32_t NamedStruct::_internal_sizes(int index) const {
  return _impl_.sizes_.Get(index);
}
inline uint32_t NamedStruct::sizes(int index) const {
  // @@protoc_insertion_point(field_get:substrait.NamedStruct.sizes)
  return _internal_sizes(index);
}
inline void NamedStruct::set_sizes(int index, uint32_t value) {
  _impl_.sizes_.Set(index, value);
  // @@protoc_insertion_point(field_set:substrait.NamedStruct.sizes)
}
inline void NamedStruct::_internal_add_sizes(uint32_t value) {
  _impl_.sizes_.Add(value);
}
inline void NamedStruct::add_sizes(uint32_t value) {
  _internal_add_sizes(value);
  // @@protoc_insertion_point(field_add:substrait.NamedStruct.sizes)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< uint32_t >&
NamedStruct::_internal_sizes() const {
  return _impl_.sizes_;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< uint32_t >&
NamedStruct::sizes() const {
  // @@protoc_insertion_point(field_list:substrait.NamedStruct.sizes)
  return _internal_sizes();
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< uint32_t >*
NamedStruct::_internal_mutable_sizes() {
  return &_impl_.sizes_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< uint32_t >*
NamedStruct::mutable_sizes() {
  // @@protoc_insertion_point(field_mutable_list:substrait.NamedStruct.sizes)
